  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className="relative flex flex-col items-start justify-between overflow-hidden border-r border-white/10 bg-[url(../assets/bg-stars.svg)] px-28 py-16">
        {/* Blur */}
        <div className="tras absolute right-0 top-1/2 h-[288px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full bg-purple-700 opacity-50 blur-full" />
        {/* Stripes */}
        ...
        <div className="space-y-5">
          <Image src={pageLogo} alt="image logo" />
